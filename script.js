...
form.addEventListener("submit", function (e) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _b.trys.push([1, 3, , 4]);
                return [4 /*yield*/, fetchAddress(cep)];
            case 2:
                address = _b.sent();
                if (address.erro) {
...
function showAddress(address) {
    result.innerHTML = "\n    <h2 class=\"result-title\">Endere\u00E7o encontrado:</h2>\n    <p><strong>Rua:</strong> ".concat(address.logradouro, "</p>\n    <p><strong>Bairro:</strong> ").concat(address.bairro, "</p>\n    <p><strong>Cidade:</strong> ").concat(address.localidade, "</p>\n    <p><strong>Estado:</strong> ").concat(address.uf, "</p>\n    <p><strong>CEP:</strong> ").concat(address.cep, "</p>\n  ");
}
